...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Dune",R.drawable.dune, R.drawable.dune2, "\"Duna: Parte Dos\" Paul Atreides se une a Chani y a los Fremen mientras busca venganza contra los conspiradores que destruyeron a su familia. Enfrentándose a una elección entre el amor de su vida y el destino del universo, debe evitar un futuro terrible.", arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Ghostbusters Apocalipsis", R.drawable.ghostbuster, R.drawable.ghostbusters,"la familia Spengler regresa al lugar donde empezó todo- el icónico parque de bomberos de Nueva York- para formar equipo con los Cazafantasmas originales, que han desarrollado un laboratorio de investigación ultrasecreto para llevar la caza de fantasmas al siguiente nivel.",arrayListOf<Cliente>()))
        ...
        peliculas.add(Pelicula("Vidas pasadas", R.drawable.vidaspasadas, R.drawable.vidaspasadas1, "Nora y Hae Sung, dos amigos de la infancia profundamente conectados, se separan cuando la familia de Nora emigra de Corea del Sur. Décadas más tarde, se reencuentran durante una fatídica semana mientras enfrentan el destino, el amor y las decisiones que marcan la vida.",arrayListOf<Cliente>()))
    }

    fun cargarSeries(){
        series.add(Pelicula("Avatar: La leyenda de Aang", R.drawable.ant, R.drawable.avatar, "La serie se centra en el viaje de Aang, de 12 años, el Avatar actual y último superviviente de su nación, los Nómadas del Aire, junto con sus amigos Sokka, Katara y más tarde Toph, mientras se esfuerzan por poner fin a la guerra de la Nación del Fuego contra las otras naciones del mundo.",arrayListOf<Cliente>()))
        series.add(Pelicula("Halo", R.drawable.halo, R.drawable.halos, "La historia principal se centra en un conflicto interestelar entre los humanos y unos alienígenas guiados por unos profetas obsesionados con una antigua especie conocida como los Forerunners.",arrayListOf<Cliente>()))
        ...
        series.add(Pelicula("Mi adorable demonio", R.drawable.adorabledemonio, R.drawable.adorabledemonios, "Un día las cosas comienzan a cambiar para ella, pues por obra de magia termina cruzando caminos con Jung Koo Won, quien en realidad es un demonio que termina perdiendo sus poderes por lo tanto ahora se ha vuelto como cualquier hombre más en la Tierra.",arrayListOf<Cliente>()))
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.elmonstruo, R.drawable.elmonstruovieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana. Ve todo lo que quieras.",arrayListOf<Cliente>()))
        series.add(Pelicula("Witcher", R.drawable.thewitcher, R.drawable.thewitchers, "Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destino por un mundo turbulento en el que, a menudo, los humanos son peores que las bestias. Ve todo lo que quieras. Henry Cavill protagoniza esta saga épica de monstruos, magia y destino basada en las novelas de Andrzej Sapkowski.",arrayListOf<Cliente>()))
    }
}
